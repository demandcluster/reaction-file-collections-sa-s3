"use strict";Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _stream = require("stream");
var _s = _interopRequireDefault(require("aws-sdk/clients/s3"));
var _fileCollectionsSaBase = _interopRequireDefault(require("@reactioncommerce/file-collections-sa-base"));
var _debug = _interopRequireDefault(require("./debug"));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}
...
class S3Store extends _fileCollectionsSaBase.default {
  ...
  {}) {
    super({
      ...
      name,
      transformRead,
      transformWrite });_defineProperty(this, "typeName",
